 ...
 if (isset($_GET['deliv'])) {
	...
	if ($deliv_sql) {?>
		<script type="text/javascript">
			alert('You successifully delivered the order');
...
if (isset($_GET['delete'])) {
	...
	//$arc_query = mysqli_query($conn, $sql_arch);
	 ...
	 $rec_sql = $conn->query("SELECT * FROM orders WHERE archive ='1' AND delivery = '0' ORDER BY id ASC");
...
<body>
	<h1 style="text-align: center;" class="bg-primary fixed-top">Delayed Orders</h1>
			...
			<div class="col-md-10">
				<table class="table table-striped table-hover table-bordered" style="padding: 10px;">
					...
					<tr>
						...
						<td>
							<h5><span class="badge badge-danger">Not Delivered</span></h5>
						</td>
